...
require (
	github.com/CodingForFunAndProfit/caddy-restrict-prefix v0.0.0-20220402180104-8607fc0372f0
	github.com/CodingForFunAndProfit/caddy-toml-adapter v0.0.0-20220402150104-91422127fcf8
